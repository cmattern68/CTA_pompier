...
namespace cta::engine::button {
    ...
    bool RectangleShapeButton::isClicked(std::shared_ptr<cta::engine::Window> &window, std::shared_ptr<cta::engine::Event> &evt) {
    ...
    void RectangleShapeButton::draw(std::shared_ptr<cta::engine::Window> &window) {
